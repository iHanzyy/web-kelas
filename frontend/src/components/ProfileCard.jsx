  ...
  return (
    <div className="flex items-end flex-col bg-background-secondary w-fit h-fit">
      <div className="flex flex-col w-56 h-56 bg-card">
        <img src={src || "/rick-astley.avif"} className="w-full h-full object-cover object-[50%_30%] brightness-95 hover:brightness-100 transition-all ease-in duration-300" />
      </div>
