  ...
  return (
    <div className=" ">
      ...
      <div className={`z-100 flex sm:hidden`}>
        <div className={`fixed z-100 pb-10 transition-all duration-300 backdrop-blur-[10px] ${isMenuOpen ? "translate-y-0" : "translate-y-[-100%]"}`}>
        ...
        <div onClick={() => setIsMenuOpen(true)} className={`${isMenuOpen ? "translate-x-[100vw]" : "translate-x-0"} cursor-pointer fixed z-100 transition-all duration-300 my-4 mx-8 size-10 flex items-center justify-center sm:hidden rounded-[50%] border-1 border-gray-500 shadow-[0_4px_30px_0_#0000001A] backdrop-blur-[6.9px]`}>
